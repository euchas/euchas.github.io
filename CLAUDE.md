...
Ground rules:
- The six pages (`index.html`, `news.html`, `research.html`, `press.html`,
  `radio.html`, `cv.html`) + `assets/styles.css` are the source of truth; nav and
  footer are duplicated in all six files — keep them in sync. Never regenerate from
